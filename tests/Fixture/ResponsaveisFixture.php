...
class ResponsaveisFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'parentesco' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'responsaveis_ibfk_1' => ['type' => 'foreign', 'columns' => ['endereco_id'], 'references' => ['enderecos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'responsaveis_ibfk_2' => ['type' => 'foreign', 'columns' => ['telefone_id'], 'references' => ['telefones', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'endereco_id' => 1,
                'telefone_id' => 1,
                'data_criacao' => '2020-12-01 04:11:09',
                'data_modificacao' => '2020-12-01 04:11:09',
                'data_delecao' => '2020-12-01 04:11:09'
            ],
        ];
        parent::init();
    }
