...
class AlunosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'endereco_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'alunos_ibfk_1' => ['type' => 'foreign', 'columns' => ['endereco_id'], 'references' => ['enderecos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'sexo' => 'L',
                'endereco_id' => 1,
                'data_criacao' => '2020-11-28 22:08:57',
                'data_modificacao' => '2020-11-28 22:08:57',
                'data_delecao' => '2020-11-28 22:08:57'
            ],
        ];
        parent::init();
    }
