 ...
 * @var \App\Model\Entity\Responsavelaluno[]|\Cake\Collection\CollectionInterface $responsavelaluno
 */
...
<div class="responsavelaluno index large-9 medium-8 columns content">
    <h3><?= __('Responsavelaluno') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($responsavelaluno as $responsavelaluno): ?>
            <tr>
