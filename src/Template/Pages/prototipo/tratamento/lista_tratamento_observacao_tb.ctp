...
<?php $this->assign('title','Buscar Tratamento para Adicionar Observação') ?>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <table class="table">
      ...
      <tbody>
        <tr>
          <td><?= $this->Html->link('<i class="fas fa-pencil-alt" style="font-size:13px;color:#216376"></i>',['controller'=>'pages','action'=>'prototipo/tratamento/adicionar_observacao_tb'],['escape'=>false,'class'=>'btn btn-xs btn-default','title'=>'Adicionar/Ver Observaçãoes']) ?>
          </td>
          <td>Paciente 1</td>
          <td>01/01/2019</td>
          <td>Unidade 1</td>
