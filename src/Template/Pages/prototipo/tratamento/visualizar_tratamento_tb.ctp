...
<?php $this->assign('title','Visualização das Informações do Tratamento') ?>

<div class="nav-tabs-custom">
  <ul class="nav nav-tabs">
    <li ><a href="#tab_demografico" data-toggle="tab">Informações Demográficas</a></li>
    <li class="active"><a href="#tab_informacoes_clinicas" data-toggle="tab">Informações Clínicas</a></li>
