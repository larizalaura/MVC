...
<?php $this->start('script'); ?>   
  ...
  $('input:radio[name="forma_diagnostico"]').filter('[id="forma-diagnostico-1"]').iCheck('check');
  $('input:radio[name="classificao_caso"]').filter('[id="classificao-caso-2"]').iCheck('check');
  $('input:radio[name="tipo_tratamento"]').filter('[id="tipo-tratamento-1"]').iCheck('check');
  $('input:radio[name="apresentacao_paciente_unidade"]').filter('[id="apresentacao-paciente-unidade-2"]').iCheck('check');
...
<?php $this->assign('title','Edição de Cadastro do Tratamento') ?>
          ...
          <?= $this->Form->create('paciente'); ?>
            ...
            <div class="panel panel-default panel-primary">
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('data_registro',['label'=>'Data de registro do tratamento','class'=>'input-sm datemask datepicker','value'=>date('d/m/Y'),'prepend'=>'<i class="fas fa-calendar-alt"></i>']); ?>
                  </div>
                  <div class="col-md-8">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('duracao_sintomas',['label'=>'Duração de sintomas','class'=>'input-sm duracao-mask','append'=>'dias','value'=>100]); ?>
                  </div>
                  <div class="col-md-4">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <?= $this->Form->input('responsavel_unidade',['label'=>'Nome de responsável de CDT/CT','class'=>'input-sm','value'=>'Profissional 1']); ?>
                  </div>
                </div>
            ...
            <div class="panel panel-default panel-primary">
              ...
              <div class="panel-body">
                <table class="table table-condensed table-striped">
                  <tbody>
                    <tr>
                      <td><?= $this->Form->input('fuma_tabaco',['label'=>' Fuma tabaco','type'=>'checkbox','checked'=>true]); ?></td> 
                    ...
                    <tr>
                      ...
                      <td><?= $this->Form->input('bebe_cafe',['label'=>' Bebe café','type'=>'checkbox','checked'=>true]); ?></td> 
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="panel panel-default panel-primary">
              ...
              <div class="panel-body">
                ...
                <div class="row">
                  <div class="col-md-5">
                    <?= $this->Form->input('vive_mesma_moradia',['label'=>'Vive com quantas pessoas na MESMA MORADIA?','class'=>'input-sm quantidade-mask','id'=>'vive-mesma-moradia','value'=>02]); ?>
                  </div>
                  <div class="col-md-7" id="criancas-mesma-moradia-div">
                    <?= $this->Form->input('criancas_mesma_moradia',['label'=>'Quantas crianças menores que 5 anos de idade vivem na MESMA MORADIA?','class'=>'input-sm quantidade-mask','id'=>'criancas-mesma-moradia','value'=>01]); ?>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-5">
                    <?= $this->Form->input('pessoas_mesma_casa',['label'=>'Vive com quantas pessoas na MESMA CASA?','class'=>'input-sm quantidade-mask','id'=>'pessoas-mesma-casa','value'=>00]); ?>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-5">
                    <?= $this->Form->input('pessoas_casa_vizinha',['label'=>'Vive com quantas pessoas nas CASAS VIZINHAS?','class'=>'input-sm quantidade-mask','id'=>'pessoas-casa-vizinha','value'=>11]); ?>
                  </div>
                  <div class="col-md-7" id="criancas-casa-vizinha-div">
                    <?= $this->Form->input('criancas_casa_vizinha',['label'=>'Quantas crianças menores que 5 anos de idade vivem nas CASAS VIZINHAS?','class'=>'input-sm quantidade-mask','id'=>'criancas-casa-vizinha','value'=>07]); ?>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-5">
                    <?= $this->Form->input('pessoas_mesmo_quarto',['label'=>'Com quantas pessoas dorme no MESMO QUARTO?','class'=>'input-sm quantidade-mask','id'=>'pessoas-mesmo-quarto','value'=>01]); ?>
                  </div>
                  <div class="col-md-7">
                    <?= $this->Form->input('pessoas_mesma_cama',['label'=>'Com quantas pessoas dorme na MESMA CAMA?','class'=>'input-sm quantidade-mask','id'=>'pessoas-mesma-cama','value'=>01]); ?>
                  </div>
                </div>
              </div>
            </div>
