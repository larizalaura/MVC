...
<?php $this->assign('title','Buscar Tratamento') ?>
...
<div class="row">
    ...
    <div class="col-sm-offset-0 col-md-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-heading"><b>Lista de Pacientes</b></div>
...
<?= $this->Html->link('Cadastrar Novo Tratamento',['controller'=>'pages','action'=>'prototipo/tratamento/cadastrar_tratamento_tb'],['class'=>'btn btn-primary']) ?> 
<br><br>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <table class="table">
      ...
      <tbody>
        <tr>
          <td><?= $this->Html->link('<i class="fa fa-eye" style="font-size:13px;color:#216376"></i>',['controller'=>'pages','action'=>'prototipo/tratamento/visualizar_tratamento_tb'],['escape'=>false,'class'=>'btn btn-xs btn-default','title'=>'Visualizar Cadastro']) ?>
          <?= $this->Html->link('<i class="fas fa-edit" style="font-size:13px;color:#216376"></i>',['controller'=>'pages','action'=>'prototipo/tratamento/editar_tratamento_tb'],['escape'=>false,'class'=>'btn btn-xs btn-default','title'=>'Editar Cadastro']) ?></td>
          <td>Paciente 1</td>
          <td>01/01/2019</td>
          <td>Unidade 1</td>
          <td>000001</td>
