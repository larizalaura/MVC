...
<?php $this->start('script'); ?>   
  ...
  $('#data-exame-vih-div').hide();
  $('#resultado-exame-vih-div').hide();
  $('#paciente-resultado-vih-div').hide();
  $("#teste-vih-0").on('ifChecked',function(event){
    $('#data-exame-vih-div').show();
    $('#resultado-exame-vih-div').show();
    $('#paciente-resultado-vih-div').show();
  });
  $("#teste-vih-1").on('ifChecked',function(event){
    $('#data-exame-vih-div').hide();
    $('#resultado-exame-vih-div').hide();
    $('#paciente-resultado-vih-div').hide();
  });
  ...
  $('#data-bactrim-div').hide();
  $("#profilaxia-bactrim-0").on('ifChecked',function(event){
    $('#data-bactrim-div').show();
  });
  $("#profilaxia-bactrim-1").on('ifChecked',function(event){
    $('#data-bactrim-div').hide();
  });

  $('#data-arv-div').hide();
  $("#tratamento-arv-0").on('ifChecked',function(event){
    $('#data-arv-div').show();
  });
  $("#tratamento-arv-1").on('ifChecked',function(event){
    $('#data-arv-div').hide();
  });
...
<?php $this->assign('title','Cadastro do Tratamento') ?>
          ...
          <?= $this->Form->create('paciente'); ?>
            <div class="panel panel-default panel-primary">
              <div class="panel-heading">
                ...
                <button type="button" data-toggle="modal" data-target="#modalBuscarPaciente" class="btn btn-default btn-xs"><i
            ...
            <div class="panel panel-default panel-primary">
              <div class="panel-heading">
                <b>Atividades TB-VIH</b> 
              </div>
              <div class="panel-body">
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('teste_vih',['label'=>'O paciente foi submetido à teste VIH?','type'=>'radio','name'=>'teste_vih','options'=>['sim','não'],'id'=>'teste-vih']); ?>
                  </div>
                  <div class="col-md-2" id="data-exame-vih-div">
                    <?= $this->Form->input('data_exame_vih',['label'=>'Data do exame VIH','class'=>'input-sm datemask datepicker','value'=>date('d/m/Y'),'prepend'=>'<i class="fas fa-calendar-alt"></i>']); ?>
                  </div>
                  <div class="col-md-3" id="resultado-exame-vih-div">
                    <?= $this->Form->input('resultado_exame_vih',['label'=>'Resultado do exame VIH','type'=>'select','options'=>['Negativo','Positivo(1,2,1&2,4)'],'empty'=>'-']); ?>
                  </div>
                  <div class="col-md-3" id="paciente-resultado-vih-div">
                    <?= $this->Form->input('paciente_resultado_vih',['label'=>'O paciente conhece o resultado de teste de VIH?','type'=>'radio','name'=>'paciente_resultado_vih','options'=>['sim','não']]); ?>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('profilaxia_bactrim',['label'=>'Profilaxia com Bactrim?','type'=>'radio','name'=>'profilaxia_bactrim','options'=>['sim','não'],'id'=>'profilaxia-bactrim']); ?>
                  </div>
                  <div class="col-md-2" id="data-bactrim-div">
                    <?= $this->Form->input('data_bactrim',['label'=>'Data da profilaxia','class'=>'input-sm datemask datepicker','value'=>date('d/m/Y'),'prepend'=>'<i class="fas fa-calendar-alt"></i>']); ?>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('tratamento_arv',['label'=>'Tratamento com ARV?','type'=>'radio','name'=>'tratamento_arv','options'=>['sim','não'],'id'=>'tratamento-arv']); ?>
                  </div>
                  <div class="col-md-3" id="data-arv-div">
                    <?= $this->Form->input('data_arv',['label'=>'Data do tratamento ARV','class'=>'input-sm datemask datepicker','value'=>date('d/m/Y'),'prepend'=>'<i class="fas fa-calendar-alt"></i>']); ?>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('registro_tarv',['label'=>'Número do registro TARV (NIPS)','class'=>'input-sm']); ?>
                  </div>
                </div>
              </div>
            </div>
