          ...
          <?= $this->Form->create('paciente'); ?>
            <div class="panel panel-default panel-primary">
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('data_registro',['label'=>'Data de registro','class'=>'input-sm datemask datepicker','value'=>"01/01/2019",'prepend'=>'<i class="fas fa-calendar-alt"></i>']); ?>
                  </div>
                  <div class="col-md-4">
                    <?= $this->Form->input('n_doente',['label'=>'Nº paciente','class'=>'input-sm','id'=>'n-doente','value'=>"000001"]); ?>
                  </div>
                  <div class="col-md-4">
                    <?= $this->Form->input('identificacao',['label'=>'Código de identificação','class'=>'input-sm','readonly'=>true,'id'=>'identificacao','value'=>"201901001000001"]); ?>
                  </div>
                </div>
              </div>
            </div>
            <div class="panel panel-default panel-primary">
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('nome_doente',['label'=>'Nome do paciente','value'=>"Paciente 1"]); ?>
                  </div>
                  <div class="col-md-2">
                    <?= $this->Form->input('idade_anos',['label'=>'Idade(anos)','class'=>'input-sm','value'=>"20"]); ?>
                  </div>
                  <div class="col-md-2">
                    <?= $this->Form->input('idade_meses',['label'=>'Idade(meses)','class'=>'input-sm']); ?>
                  </div>
                  <div class="col-md-4">
                    <?= $this->Form->input('sexo',['label'=>'Sexo','class'=>'input-sm','options'=>['Masculino','Feminino'],'empty'=>'-','id'=>'sexo','value'=>"Masculino"]); ?>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4">
              ...
              <div class="panel-body">
                ...
                <div class="box box-default color-palette-box">
                  <table class="table table-condensed table-striped">
                    ...
                    <tbody>
                      <tr>
                        <td><?= $this->Form->input('mecanico',['label'=>' Mecânico','type'=>'checkbox', 'checked'=>true]); ?></td> 
            ...
            <div class="panel panel-default panel-primary">
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('telefone1',['label'=>'Nº do Telemóvel 1','class'=>'input-sm telefone','prepend'=>'<i class="fas fa-phone-alt"></i>','value'=>"(245)9099-0989"]); ?>
                  </div>
                  <div class="col-md-4">
            ...
            <div class="panel panel-default panel-primary ">
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('nome_pessoa_referencia',['label'=>'Nome da Pessoa de Referência','class'=>'input-sm','value'=>"Pessoa 1"]); ?>
                  </div>
                  <div class="col-md-2">
                    <?= $this->Form->input('idade_pessoa_referencia',['label'=>'Idade (em anos)','class'=>'input-sm','value'=>"30"]); ?>
                  </div>
                  <div class="col-md-3">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <?= $this->Form->input('telefone1',['label'=>'Nº do Telemóvel da Pessoa de Referência 1','class'=>'input-sm telefone','prepend'=>'<i class="fas fa-phone-alt"></i>','value'=>"(245)9099-0999"]); ?>
                  </div>
                  <div class="col-md-4">
