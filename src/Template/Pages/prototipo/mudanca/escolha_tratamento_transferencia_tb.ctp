...
<?php $this->assign('title','Buscar Tratamento para Cadastrar Transferência') ?>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <table class="table">
      ...
      <tbody>
        <tr>
          <td><?= $this->Html->link('<i class="fas fa-ambulance" style="font-size:13px;color:#216376"></i>',['controller'=>'pages','action'=>'prototipo/mudanca/cadastrar_transferencia_tb'],['escape'=>false,'class'=>'btn btn-xs btn-default','title'=>'Escolher Paciente para Cadastrar Transferência']) ?></td>
          <td>Paciente 1</td>
          <td>01/01/2019</td>
          <td>Unidade 1</td>
          <td>000001</td>
