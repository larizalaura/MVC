...
<?php $this->assign('title','Cadastro da Transferência') ?>
      ...
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="socio_demograficas">
          <?= $this->Form->create('paciente'); ?>
            ...
            <div class="panel panel-default panel-primary">
              <div class="panel-heading">
                <b>Transferências referente ao tratamento</b> 
              </div>
              <div class='panel-body'>
                <div class="row">
                  <div class="col-md-12">
                    <table class="table table-condensed table-striped">
                      <thead>
                        <tr>
                          ...
                          <th>Unidade Remetente</th>
                          <th>Unidade Destinatária</th>
                          <th>Confirmação</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td><?= $this->Html->link('<i class="fas fa-edit" style="font-size:13px;color:#216376"></i>',['controller'=>'pages','action'=>'prototipo/mudanca/editar_transferencia_tb'],['escape'=>false,'class'=>'btn btn-xs btn-default','title'=>'Editar Transferência']) ?>
                          <button type="button" data-toggle="modal" data-target="#modalRemoverTransferencia" class="btn btn-default btn-xs" title="Remover transferência" id="remover-transferencia"><i class="fas fa-trash-alt" style="font-size:13px;color:#216376"></i></button></td>
                          <td>01/05/2019</td>
                          <td>RS001 - CDT001 - CT001</td>
                          <td>RS001 - CDT001 - CT002</td>
                          <td class ="label bg-green">Sim</td>
                        </tr>
                        <tr>
                          <td><?= $this->Html->link('<i class="fas fa-edit" style="font-size:13px;color:#216376"></i>',['controller'=>'pages','action'=>'prototipo/mudanca/editar_transferencia_tb'],['escape'=>false,'class'=>'btn btn-xs btn-default','title'=>'Editar Exame']) ?>
                          <button type="button" data-toggle="modal" data-target="#modalRemoverTransferencia" class="btn btn-default btn-xs" title="Remover transferência" id="remover-transferencia"><i class="fas fa-trash-alt" style="font-size:13px;color:#216376"></i></button></td>
                          <td>01/06/2019</td>
                          <td>RS001 - CDT001 - CT002</td>
                          <td>RS001 - CDT001 - CT003</td>
                          <td class ="label bg-red">Não</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Confirmação das informações da transferência</h4>
      </div>
...
<div class="modal modal-success fade" tabindex="-1" role="dialog" id="modalRemoverTransferencia">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span></button>
        <h4 class="modal-title">Confirmação das remoção da transferência</h4>
      </div>
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <h3>Remover a transferência?</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <dl class="dl-horizontal">
              <dt>Data da transferẽncia</dt>
                <dd>01/05/2019</dd>
              <dt>Unidade Remetente</dt>
                <dd>BRS001 - CDT001 - CT001</dd>
              <dt>Unidade Destinatária</dt>
                <dd>BRS001 - CDT001 - CT002</dd>
              <dt>Confirmação</dt>
                <dd>Sim</dd>
            </dl>
          </div>
